...
{
    internal class NetherlandsBanksFacade : IExchangeRateProvider
    {
        private readonly List<IExchangeRateProvider> _localBanks;

        public NetherlandsBanksFacade()
        {
        ...
        public async Task<List<Currency>> GetRatesAsync()
        {
            ...
            {
                Console.WriteLine($"[NETHERLANDS FACADE CRITICAL] Eurosystem unavailable: {ex.Message}");
