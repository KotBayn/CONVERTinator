...
{
    internal class FranceBanksFacade : IExchangeRateProvider
    {
        private readonly List<IExchangeRateProvider> _localBanks;

        public FranceBanksFacade()
        {
        ...
        public async Task<List<Currency>> GetRatesAsync()
        {
            ...
            {
                Console.WriteLine($"[FRANCE FACADE CRITICAL] Eurosystem unavailable: {ex.Message}");
