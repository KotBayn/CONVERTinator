...
{
    internal class PortugalBanksFacade : IExchangeRateProvider
    {
        private readonly List<IExchangeRateProvider> _localBanks;

        public PortugalBanksFacade()
        {
        ...
        public async Task<List<Currency>> GetRatesAsync()
        {
            ...
            {
                Console.WriteLine($"[PORTUGAL FACADE CRITICAL] Eurosystem unavailable: {ex.Message}");
