...
{
    internal class FinlandBanksFacade : IExchangeRateProvider
    {
        private readonly List<IExchangeRateProvider> _localBanks;

        public FinlandBanksFacade()
        {
        ...
        public async Task<List<Currency>> GetRatesAsync()
        {
            ...
            {
                Console.WriteLine($"[FINLAND FACADE CRITICAL] Eurosystem unavailable: {ex.Message}");
