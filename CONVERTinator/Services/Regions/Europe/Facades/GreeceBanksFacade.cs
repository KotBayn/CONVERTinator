...
{
    internal class GreeceBanksFacade : IExchangeRateProvider
    {
        private readonly List<IExchangeRateProvider> _localBanks;

        public GreeceBanksFacade()
        {
        ...
        public async Task<List<Currency>> GetRatesAsync()
        {
            ...
            {
                Console.WriteLine($"[GREECE FACADE CRITICAL] Eurosystem unavailable: {ex.Message}");
