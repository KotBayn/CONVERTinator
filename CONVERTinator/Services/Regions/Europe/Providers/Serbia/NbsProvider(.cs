...
namespace CONVERTinator.Services.Regions.Europe.Providers.Serbia
{
    public class NbsProvider : IExchangeRateProvider
    {
        private readonly HttpClient _httpClient = new HttpClient();
        private const string Url = "https://www.nbs.rs/arfolyamok.asmx/ArfolyamXml"; // Narodna Banka Srbije
        ...
        public async Task<List<Currency>> GetRatesAsync()
        {
            ...
            try
            {
                ...
                XNamespace ns = "http://www.nbs.rs/xsd";
                ...
                foreach (var element in doc.Descendants(ns + "Rate"))
                {
                    ...
                    {
                        Code = code,
                        Name = code, // NBS XML omits full currency names
            ...
            {
                Console.WriteLine($"[NBS Provider Error]: {ex.Message}");
            }
            return result;
        }
    }
